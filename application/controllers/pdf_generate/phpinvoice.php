...
$con=mysqli_connect("localhost","root","Onetoeight30","marketing");
		$query=mysqli_query($con,"SELECT * FROM `config` WHERE code='CURRENCY'");
	...
	public function addItem($item,$description = "",$quantity,$price,$total) {
		//$p['item'] 			= $this->br2nl($item);
$p['description'] 			= $item;
		//$p['item'] = $this->MultiCell(200, 5, $item,0,'L');
		$p['item'] 	= $this->br2nl($description);
