                                    ...
                                    <form role="form" method="post" name="valide_size">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" name="size_name_ar" required value="<?php echo $row['name_ar'];?>">
                                                        <label for="form_control_coupon_code">Size Arabic</label>
                                                        <span class="help-block">Size name arabic goes here...</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
