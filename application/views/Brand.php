                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> Manage Brand</span>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <div class="btn-group pull-right">
                                                <button class="btn red"  onclick="window.location.href='<?php echo base_url('Add_Brand'); ?>'"> <i class="glyphicon glyphicon-plus"></i>Add
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        var dataTable = $('#example').DataTable( {
            ...
            "ajax":{
                url : '<?php echo base_url(); ?>Brand/get_brand_data', // json datasource
    ...
    function delete_user(){
        if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>Brand/delete_brand_data",
    ...
    function delete_single_user(single_id){
        swal({
            ...
            function(){
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>Brand/delete_single_brand_data",
