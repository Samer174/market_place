        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="<?php echo base_url()?>assets/front/images/home-banner/shopping-online.jpeg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="<?php echo base_url()?>assets/front/images/home-banner/shopping-2.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part" style="opacity: 0.7;">
                                <img src="<?php echo base_url()?>assets/front/images/men-cloth.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part" style="opacity: 0.7;">
                                <img src="<?php echo base_url()?>assets/front/images/women-Online-Shopping.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="<?=base_url()?>assets/front/images/parallax/1.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <?php
                            foreach($categories_with_preiority as $key => $cat)
                            {
                                echo '<li class="';
                                if($key == 0)
                                {
                        ...
                        <?php
                        echo '<div class="tab-content-cls">';
                        foreach($products_category_with_priority as $key => $val)
                            {
                                echo '<div id="tab-'.$val["category_id"].'" class="tab-content '; if($key == 0) {echo 'active default';} echo '">
                                        <div class="no-slider row">';
                                      
                                            foreach($products_category_with_priority_main as $row)
                                            {
                                        ...
                                        <form
                                            ...
                                            <div class="form-group mx-sm-3">
                                                ...
                                                <button type="submit" class="btn btn-solid"
                                                    id="mc-submit"><?php echo $this->lang->line('subscribe'); ?></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
