    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="<?=base_url();?>assets/front/images/about/about%20us.jpg"
                ...
                <div class="col-sm-12">
                    <div class="slide-2 testimonial-slider no-arrow">
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="<?=base_url();?>assets/front/images/avtar.jpg" alt="#">
                                    <h5>Mark Jecno</h5>
                                    <h6>Designer</h6>
                                </div>
                        ...
                        <div>
                            <div class="media">
                                <div class="text-center">
                                    <img src="<?=base_url();?>assets/front/assets/images/avtar.jpg" alt="#">
                                    <h5>Mark Jecno</h5>
                                    <h6>Designer</h6>
                                </div>
                                <div class="media-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        ...
                        <div>
                            <div>
                                <img src="<?=base_url();?>assets/front/images/team/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="<?=base_url();?>assets/front/images/team/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="<?=base_url();?>assets/front/images/team/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
