                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        ...
                                                        <span class="help-block">Brand Name goes here...</span>
                                                        <input type="hidden" name="brand_id" value="<?php echo $row['brand_id'];?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" name="brand_name_ar" value="<?php echo $row['brand_name_ar'];?>" required>
                                                        <label for="form_control_coupon_code">Brand Name Arabic</label>
                                                        <span class="help-block">Brand Name Arabic goes here...</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
