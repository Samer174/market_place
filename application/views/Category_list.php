                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <div class="btn-group pull-right">
                                                <button class="btn red"  onclick="window.location.href='<?php echo base_url('index.php/manage_cat/add_category'); ?>'"> <i class="glyphicon glyphicon-plus"></i>Add
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <tr>
                                        <th>
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" id="Select_all" class="group-checkable"  />
                                                <span></span>
                                            </label>
                                        </th>
                                        <th>icon</th>
...
<script type="text/javascript" language="javascript" >
    ...
    $(document).ready(function() {
        ...
        $('#reviews').DataTable({
            "iDisplayLength": 10,
            ajax: '<?php echo base_url('Manage_cat/get_data_of_cat'); ?>',
            columns: [
                { data: "cheked"},
                { data: "icon"},
                { data: "name" },
    ...
    function delete_cat(id) {
        swal({
            ...
            function(){
                $.ajax({
                    'url':'<?php echo base_url('Manage_cat/delete/'); ?>',
                    'method':'POST',
                    'data':{'id':id},
                    'success':function(){
    ...
    $('#multi_delete').click(function (){
        ...
        swal({
            ...
            function () {
                swal("Deleted!", "Your imaginary file has been deleted.", "success");
                $.ajax({
                    'url':'<?php echo base_url('Manage_cat/multi_delete'); ?>',
                    'data':{'id':abc},
                    'method':'post',
    ...
    function status_change(id){
        $.ajax({
            'url':'<?php echo base_url('Manage_cat/checkstatus'); ?>',
            'method':'post',
            'data':{'id':id},
            'success':function (data) {
                $('#status'+id).text(data);
                if(data == 'Active'){
                    ...
                    $('#status'+id).removeClass('label-default');
                }
                if(data == 'Inactive'){
                    $('#status'+id).addClass('label-default');
