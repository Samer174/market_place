                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        ...
                                                        <span class="help-block">Tag Name is Goes <Here></Here>...</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" name="tag_name_ar" required>
                                                        <label for="form_control_coupon_code">Name Arabic</label>
                                                        <span class="help-block">Tage Name Arabic is Goes <Here></Here>...</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
