...
var Dashboard = function() {
    ...
    return {
        ...
        initCharts: function() {
            ...
            var data22=$("#rides").val();
            var data=JSON.parse(data22);
...
$('.uservisit').click(function(){
    //alert("hello");
    var year=$(this).attr('data-val');
    $.post('dashboard',{year_user:year},function(response){
        $('#rides').val(response);
        var data22=$("#rides").val();
        var data=JSON.parse(data22);
        ...
        var plot_statistics = $.plot($("#site_statistics"), [{
            ...
            if ($('#site_activities').size() != 0) {
                ...
                var data21=$("#revenue").val();
                var data=JSON.parse(data21);
                var data1 =data;
            ...
            $('.graph').click(function(){
               var year=$(this).attr('data-val');
               $.post('dashboard',{year:year},function(response){
